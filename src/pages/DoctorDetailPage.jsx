...
const doctors = [
  ...
  },
  {
    ...
    totalReviews: 98,
    achievements: [
      "Thực hiện thành công hơn 400 ca IUI",
      "Nghiên cứu sinh tại Đại học Y Hà Nội",
      "Chuyên gia về nội tiết sinh sản",
      "Đã công bố nhiều bài báo khoa học về điều trị vô sinh",
    ],
    workingHours: {
      monday: "08:00 - 17:00",
      tuesday: "08:00 - 17:00",
  ...
  },
  {
    ...
    totalReviews: 85,
    achievements: [
      "Thực hiện thành công hơn 200 ca IVF",
      "Nghiên cứu sinh tại Đại học Y Dược TP.HCM",
      "Chuyên gia về sản phụ khoa",
      "Đã tham gia nhiều hội thảo quốc tế về hỗ trợ sinh sản",
    ],
    workingHours: {
      monday: "08:00 - 17:00",
      tuesday: "08:00 - 17:00",
