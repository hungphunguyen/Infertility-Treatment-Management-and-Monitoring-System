      ...
      <div className="px-4 py-8 max-w-5xl mx-auto">
        ...
        >
          <Row gutter={[32, 32]} align="middle">
            ...
            <Col xs={24} md={14}>
              <Title level={2} className="mb-4 text-orange-500" style={{ 
                fontSize: '2.5rem',
                fontWeight: '700',
              ...
              <div className="space-y-3">
                <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className="font-semibold mr-2 text-orange-400">Chuyên khoa:</span>
                  <span className="text-gray-800">{doctor.specialty || "Chưa cập nhật"}</span>
                </div>
                <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                  <MailOutlined className="mr-3 text-orange-400 text-lg" />
                  <span className="font-semibold mr-2 text-orange-400">Email:</span>
                  <span className="text-gray-800">{doctor.email || "Chưa cập nhật"}</span>
                </div>
                <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                  <PhoneOutlined className="mr-3 text-orange-400 text-lg" />
                  <span className="font-semibold mr-2 text-orange-400">Số điện thoại:</span>
                  <span className="text-gray-800">{doctor.phoneNumber || "Chưa cập nhật"}</span>
                </div>
                <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                  <span className="mr-3 text-orange-400 font-semibold">Bằng cấp:</span>
                  <span className="text-gray-800">{doctor.qualifications || "Chưa cập nhật"}</span>
                </div>
                <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                  <span className="mr-3 text-orange-400 font-semibold">Năm tốt nghiệp:</span>
                  <span className="text-gray-800">{doctor.graduationYear || "Chưa cập nhật"}</span>
                </div>
                <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                  <span className="mr-3 text-orange-400 font-semibold">Địa chỉ:</span>
                  <span className="text-gray-800">{doctor.address || "Chưa cập nhật"}</span>
                </div>
                <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                  <span className="mr-3 text-orange-400 font-semibold">Kinh nghiệm:</span>
