...
const ManagerTreatmentRecords = () => {
  ...
  const expandedRowRender = (record) => {
    const columns = [
      {
        ...
        render: (text, treatment) => {
          ...
          const serviceName = treatment.treatmentServiceName || 
          ...
          return (
            <div style={{ padding: '12px', background: '#f8f9fa', borderRadius: '6px', border: '1px solid #e9ecef' }}>
              ...
              {treatment.price && (
                <div>
                  <Text style={{ fontSize: '12px', color: '#28a745', fontWeight: '500' }}>
              ...
              <div>
                <div style={{ marginBottom: '4px' }}>
                  <Button
                    ...
                    style={{ width: '100%', background: '#28a745', borderColor: '#28a745' }}
                  >
                    Duyệt
                  </Button>
                </div>
    ...
    return (
      <div style={{ padding: '16px', background: '#ffffff', borderRadius: '8px', margin: '8px 0', border: '1px solid #dee2e6' }}>
        <Table
          columns={columns}
